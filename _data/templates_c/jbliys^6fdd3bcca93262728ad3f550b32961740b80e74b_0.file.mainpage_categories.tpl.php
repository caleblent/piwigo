<?php
/* Smarty version 4.3.1, created on 2024-10-17 06:41:48
  from 'C:\xampp\htdocs\piwigo\themes\modus\template\mainpage_categories.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_6710958cc0d4d1_17368136',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6fdd3bcca93262728ad3f550b32961740b80e74b' => 
    array (
      0 => 'C:\\xampp\\htdocs\\piwigo\\themes\\modus\\template\\mainpage_categories.tpl',
      1 => 1729120857,
      2 => 'file',
    ),
  ),
...
function content_6710958cc0d4d1_17368136 (Smarty_Internal_Template $_smarty_tpl) {
...
{.thumbnailCategory .illustration{width:<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( ($_smarty_tpl->tpl_vars['derivative_params']->value->max_width()/2+5) ));?>
px;}.content .thumbnailCategory .description{height:<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( ($_smarty_tpl->tpl_vars['derivative_params']->value->max_height()/2+5) ));?>
px;}.illustration IMG{max-width:<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( ($_smarty_tpl->tpl_vars['derivative_params']->value->max_width()/2) ));?>
...
px;}}@media (max-width: <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( (2+2*($_smarty_tpl->tpl_vars['derivative_params']->value->max_width()+1+120)) ));?>
px),<?php ob_start();
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( (2+2*($_smarty_tpl->tpl_vars['derivative_params']->value->max_width()/2+1+120)) ));
