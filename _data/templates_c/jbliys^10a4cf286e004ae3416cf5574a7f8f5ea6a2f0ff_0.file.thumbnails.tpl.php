<?php
/* Smarty version 4.3.1, created on 2024-10-17 06:41:50
  from 'C:\xampp\htdocs\piwigo\themes\modus\template\thumbnails.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_6710958ecc7017_43221828',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '10a4cf286e004ae3416cf5574a7f8f5ea6a2f0ff' => 
    array (
      0 => 'C:\\xampp\\htdocs\\piwigo\\themes\\modus\\template\\thumbnails.tpl',
      1 => 1729120857,
      2 => 'file',
    ),
  ),
...
function content_6710958ecc7017_43221828 (Smarty_Internal_Template $_smarty_tpl) {
...
{.thumbnails SPAN,.thumbnails .wrap2 A{width:<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( ($_smarty_tpl->tpl_vars['derivative_params']->value->max_width()/1.5+2) ));?>
px}.thumbnails .wrap2{height:<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( ($_smarty_tpl->tpl_vars['derivative_params']->value->max_height()/1.5+3) ));?>
px}.thumbnails .wrap2 IMG{max-width:<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( ($_smarty_tpl->tpl_vars['derivative_params']->value->max_width()/1.5) ));?>
px;max-height:<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( ($_smarty_tpl->tpl_vars['derivative_params']->value->max_height()/1.5) ));?>
...
{.thumbnails SPAN,.thumbnails .wrap2 A{width:<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( ($_smarty_tpl->tpl_vars['derivative_params']->value->max_width()/2+2) ));?>
px}.thumbnails .wrap2{height:<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( ($_smarty_tpl->tpl_vars['derivative_params']->value->max_height()/2+3) ));?>
px}.thumbnails .wrap2 IMG{max-width:<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( ($_smarty_tpl->tpl_vars['derivative_params']->value->max_width()/2) ));?>
px;max-height:<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( ($_smarty_tpl->tpl_vars['derivative_params']->value->max_height()/2) ));?>
...
{.thumbnails SPAN,.thumbnails .wrap2 A{width:<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( ($_smarty_tpl->tpl_vars['derivative_params']->value->max_width()/3+2) ));?>
px}.thumbnails .wrap2{height:<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( ($_smarty_tpl->tpl_vars['derivative_params']->value->max_height()/3+3) ));?>
px}.thumbnails .wrap2 IMG{max-width:<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( ($_smarty_tpl->tpl_vars['derivative_params']->value->max_width()/3) ));?>
px;max-height:<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( ($_smarty_tpl->tpl_vars['derivative_params']->value->max_height()/3) ));?>
px;}}@media<?php $_smarty_tpl->_assignInScope('maxw', call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( (2+2*($_smarty_tpl->tpl_vars['derivative_params']->value->max_width()+1+7)) )));
...
,<?php $_smarty_tpl->_assignInScope('maxw', call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( (2+2*($_smarty_tpl->tpl_vars['derivative_params']->value->max_width()/1.5+1+7)) )));
...
,<?php $_smarty_tpl->_assignInScope('maxw', call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( (2+2*($_smarty_tpl->tpl_vars['derivative_params']->value->max_width()/2+1+7)) )));
...
,<?php $_smarty_tpl->_assignInScope('maxw', call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( (2+2*($_smarty_tpl->tpl_vars['derivative_params']->value->max_width()/3+1+7)) )));
...
{.thumbnails .wrap2{height:auto;border:0}.thumbnails .thumbLegend{height:auto;min-height:4em;overflow:visible;}}@media<?php $_smarty_tpl->_assignInScope('maxw', call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( (2+($_smarty_tpl->tpl_vars['derivative_params']->value->max_width()+1+7)) )));
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['cssResolution'][0], array( array('base'=>(('(max-width:').($_smarty_tpl->tpl_vars['maxw']->value)).('px)'),'max'=>1),$_smarty_tpl ) );?>
,<?php $_smarty_tpl->_assignInScope('maxw', call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( (2+($_smarty_tpl->tpl_vars['derivative_params']->value->max_width()/1.5+1+7)) )));
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['cssResolution'][0], array( array('base'=>(('(max-width:').($_smarty_tpl->tpl_vars['maxw']->value)).('px)'),'min'=>1.3,'max'=>1.7),$_smarty_tpl ) );?>
,<?php $_smarty_tpl->_assignInScope('maxw', call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( (2+($_smarty_tpl->tpl_vars['derivative_params']->value->max_width()/2+1+7)) )));
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['cssResolution'][0], array( array('base'=>(('(max-width:').($_smarty_tpl->tpl_vars['maxw']->value)).('px)'),'min'=>1.7,'max'=>2.5),$_smarty_tpl ) );?>
,<?php $_smarty_tpl->_assignInScope('maxw', call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( (2+($_smarty_tpl->tpl_vars['derivative_params']->value->max_width()/3+1+7)) )));
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['cssResolution'][0], array( array('base'=>(('(max-width:').($_smarty_tpl->tpl_vars['maxw']->value)).('px)'),'min'=>2.5),$_smarty_tpl ) );?>
